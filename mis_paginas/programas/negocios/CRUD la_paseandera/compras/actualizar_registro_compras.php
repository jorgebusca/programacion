...
<title>Actualizar registro compras</title>
</head>

<body> 

<h1 align="center">Actualizar Compras</h1>
<p>
  <?php
...
<p>&nbsp;</p>
<form name="update" method="post" action="<?php echo $_SERVER['file:///C|/wamp64/www/PHP_SELF'];?>">
