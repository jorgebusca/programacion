...
require("../../conecciones/coneccion_bbdd_carta.php");
...
$sql="INSERT INTO MIS_PRODUCTOS (nombre, descripcion, precio, inicio, modificado, actual) VALUES ('$nombre', '$descripcion', '$precio', '$inicio', '$modificado', '$actual')";
