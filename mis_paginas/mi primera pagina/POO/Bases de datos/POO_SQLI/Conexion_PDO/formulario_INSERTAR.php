...
<h1 align="center" >Formulario INSERTAR</h1>

	<form action="INSERTAR_PDO.php" method="get">
    <table>
    ...
    <tr><td colspan="2"><input type="submit" name="enviado" value="INSERTAR"> </td></tr></table>  
    </form> 
